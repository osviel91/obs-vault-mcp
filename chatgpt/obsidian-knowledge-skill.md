...
2. Usa la respuesta como contexto inicial: `summary`, `mocs_relevantes`, `heuristicas`, `decisiones`, `contradicciones`, `obsoletas_o_baja_confianza` y `metricas`.
...
2. Antes de crear una nota, busca si ya existe una nota que pueda ampliarse, fusionarse o enlazarse.
